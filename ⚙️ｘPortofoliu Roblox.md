# 📂 Portofoliu Roblox Developer | UI Design & Scripting

> Salut! Mai jos găsești detalii despre abilitățile mele și exemple de proiecte realizate.

---
> Acestea au fost facute pentru a avea un model capabil.

### 1. 🎨 UI Design & Interactivitate
Creez meniuri moderne care nu doar arată bine, dar sunt și complet funcționale.
* **Sisteme de Navigare:** Meniuri cu tab-uri (Home, Rules, Credits) cu tranziții fluide.
* **Elemente Dinamice:** Fundaluri animate cu obiecte plutitoare și efecte de tip "Tween".
* **Personalizare:** Scripturi de "Welcome" care recunosc automat jucătorul.

> ![Meniu Principal](https://media.discordapp.net/attachments/1478467459831959563/1480647238702207169/2e70bf08-f479-4eef-b02f-dceacf82f903.png?ex=69b06fb2&is=69af1e32&hm=b029b33b735563710fc2d6e49e92fe825d032bc0b52a916239f4152bf45cd600&=&format=webp&quality=lossless&width=1238&height=777)
...
### 2. ⚙️ Sisteme de Gameplay & Scripting
Pot programa logica din spatele unui joc de succes:
* **Sistem de Colectare:** Detectarea obiectelor găsite și actualizarea bazei de date.
* **DataStore Service:** Salvarea automată a progresului (scor, obiecte colectate).
* **Server Stats:** Monitorizarea jucătorilor online și a statisticilor globale.

> ![Sistem Colectare](https://media.discordapp.net/attachments/1478467459831959563/1480647496802762835/a249e589-8296-45c3-aa04-1f91187322b3.png?ex=69b06ff0&is=69af1e70&hm=107e5054bcbe0ec582eaacdf764ab7d02c9cbaaf2f0808f12b6798ba09aa5f0c&=&format=webp&quality=lossless&width=431&height=252)

> *Sistem de tracking pentru 67 de obiecte unice cu salvare automată. Mentiune: Poza are animatie*

### 3. 📱 Optimizare Multi-Platformă
Toate interfețele create de mine sunt optimizate pentru:
* **PC** (Keyboard & Mouse support)
* **Mobile** (Touch friendly, UI Scaling corect)
* **Console** (Navigare cu controller)
